...
\setbeamertemplate{footline}{\begin{center}\textcolor{gray}{Dingel -- Topics in Trade -- \semester -- Week 12 -- \insertframenumber}\end{center}}
\usepackage{listings}
...
\item \textcolor{gray}{Annual threshold is vertical bar at 75 $\mu$g/m$^{3}$}
\item \textcolor{gray}{Daily threshold violated by non-attainment counties to left of vertical bar}
}\end{itemize}
\end{frame}
% -----------------------------------------
...
\end{frame}
% -----------------------------------------
\begin{frame}{2SLS estimates using mid-decade nonattainment IVs}
\begin{center}
...
\item 
Georeference $\geq 5,000$ chimneys and use associated building description, assigned to one of 11 industrial categories by textual analysis (keyword matching)
\item 
...
{\small Estimated pollution correlates with 1915 deposits across Manchester neighborhoods\par}
\includegraphics[height=0.60\textheight]{../images/week12/HeblichTrewZylberberg2021_fig5.pdf}\\
{\small \textcolor{gray}{More polluted places have more dark moths, who benefit from soot as camouflage}\par}
\end{column}
\end{columns}
\end{frame}
% -----------------------------------------
...
\href{http://dx.doi.org/10.3982/ECTA7636}{Costinot (2009)} \textcolor{gray}{[Recall log-supermodularity \hyperlink{appendix:LSM}{\beamergotobutton{Recall}}]}:
\begin{itemize}
...
\textcolor{gray}{\scriptsize See also \href{https://www.nber.org/papers/w32035}{Obolensky, Tabellini \& Taylor (2024)} on climate mismatch}
\end{frame}
% -----------------------------------------
