...
\begin{itemize}
	...
	\begin{center}
\raisebox{-0.5\height}{\href{http://www.businessinsider.com/the-25-most-educated-cities-in-america-2014-9}{\includegraphics[width=0.45\textwidth]{../images/week11/mosteducatedcities_businessinsider.png}}}
	\raisebox{-0.5\height}{\href{http://www.marketwatch.com/story/the-10-smartest-cities-in-america-2015-01-02}{\includegraphics[width=0.45\textwidth]{../images/week11/smartestcities_marketwatch.png}}}
		\end{center}
	\item Place names are shorthand for sectors
	\begin{center}
	\raisebox{-0.5\height}{\includegraphics[width=0.3\textwidth]{../images/week11/wallstreetsign.jpeg}}
	\raisebox{-0.5\height}{\includegraphics[width=0.4\textwidth]{../images/week11/Silicon_valley_title.png}}
	\raisebox{-0.5\height}{\includegraphics[width=0.2\textwidth]{../images/week11/detroitbigthree.jpg}}
	\end{center}
\end{itemize}
\end{frame}
% -----------------------------------------
\begin{frame}{Educational attainment varies a lot across cities}
	...
	\includegraphics[height=0.76\textheight]{../images/week11/CBSA_2009ACS_baplus_48states.pdf} \\
...
\begin{frame}{Sectoral composition varies a lot across cities}
	...
	\includegraphics[height=0.76\textheight]{../images/week11/CBSA_2009_techservicesshare.pdf}\\
...
\begin{frame}{They covary with city characteristics}
	...
	\includegraphics[height=.86\textheight]{../images/week11/CAC_figure1_edu.pdf}\\
	\vspace{-2mm}
	...
	\includegraphics[height=.86\textheight]{../images/week11/CAC_figure2_occ.pdf}\\
	\vspace{-2mm}
	\scriptsize{\textsc{Data source:} \href{http://www.bls.gov/oes/2000/oessrcma.htm}{Occupational Employment Statistics 2000}}
	}
	\only<3>{
	\includegraphics[width=.45\textwidth]{../images/week11/CAC_figure1_edu.pdf}
	\includegraphics[width=.45\textwidth]{../images/week11/CAC_figure2_occ.pdf}
	}
	\end{center}
\only<3>{
...
\begin{center}
\includegraphics[width=.45\textwidth]{../images/week11/BaumSnowPavan2013fig3a.pdf}
\includegraphics[width=.45\textwidth]{../images/week11/BaumSnowPavan2013fig3b.pdf}\\
...
\begin{itemize}
	...
	\begin{center}\includegraphics[height=.70\textheight]{../images/week11/SATscore3_trimmed.pdf}\end{center}
\end{itemize}
\end{frame}
% -----------------------------------------
...
\end{frame}
% -----------------------------------------
\begin{frame}{Sidebar: Assumptions of AKM model for OLS regressions}
See \href{https://doi.org/10.1016/bs.heslab.2024.11.005}{Kline (2024)} on strict exogeneity for Abowd Kramarz Margolis (1999)
\begin{itemize}
\item AKM assumes strict exogeneity of $\epsilon_{it}$: $\mathbb{E}\left[\epsilon_{it} | j(i,s), X_{is}\right] = 0 \ \forall i, \forall (s,t), \forall j$
$$
\ln w_{it} = \sigma_{j(i,t)} + \mu_i + \beta x_{it} + \epsilon_{it}
$$
\item Moves between firms (cities) are not driven by time-varying wage fluctuations
\item Mapping from worker and firm heterogeneity to $\mathbb{E}[\ln w]$ is additively separable
\end{itemize}
See \href{https://www.aeaweb.org/articles?id=10.1257/app.20220427}{Card, Rothstein, Yi (2025)} on US cities
\begin{columns}
\begin{column}{0.64\textwidth}
\begin{itemize}
\item {\footnotesize ``Card, Heining, and Kline (2013) and Card, Cardoso, and Kline (2016) develop a number of specification tests that address the plausibility of this assumption.''\par}
\item {\footnotesize ``We use event-study style comparisons of earnings before and after a move to show that between-CZ mobility is approximately exogenous with respect to the residuals in our underlying AKM model.''\par}
\end{itemize}
\end{column}
\begin{column}{0.35\textwidth}
\includegraphics[height=0.45\textheight]{../images/week11/CardRothsteinYi2025_figA10.pdf}
\end{column}
\end{columns}
\end{frame}
% -----------------------------------------
...
\only<1>{
	...
	\includegraphics[height=0.75\textheight]{../images/week11/delaRocaPuga2017_fig3a.pdf}
	\end{center}
}
\only<2->{\item Big-city experience is more valuable for workers with higher ability}
\only<2>{
	\begin{center}
	\includegraphics[height=0.75\textheight]{../images/week11/delaRocaPuga2017_fig7.pdf}
	\end{center}
}
\only<3->{\item There is sorting across five occupational categories}
\only<3>{
	\begin{center}
	\includegraphics[width=0.9\textwidth]{../images/week11/delaRocaPuga2017_tab5.pdf}
	\end{center}
}
\only<4->{\item Little sorting within these categories when using full dynamic specification
\begin{center}
	\includegraphics[height=0.55\textheight]{../images/week11/delaRocaPuga2017_fig8c.pdf}
	\includegraphics[height=0.55\textheight]{../images/week11/delaRocaPuga2017_fig8a.pdf}
\end{center}
}
\end{itemize}
\end{frame}
...
\only<1>{\begin{center}\includegraphics[height=0.6\textheight]{../images/week11/CarlsenRattsoStokke2016_fig1.pdf}\end{center}}
\only<2>{
\item
Sorting on unobserved abilities is driven by the college educated
\begin{center}
\includegraphics[height=0.5\textheight]{../images/week11/CarlsenRattsoStokke2016_fig2b.pdf}
\includegraphics[height=0.5\textheight]{../images/week11/CarlsenRattsoStokke2016_fig2c.pdf}
\end{center}
\item
...
\begin{center}
\includegraphics[height=0.9\textheight]{../images/week11/SKE_2citywageschedule.pdf}
\end{center}
\end{frame}
% -----------------------------------------
...
\begin{center}
\includegraphics[height=.90\textheight]{../images/week11/Diamond2016_fig1.pdf}\
\end{center}
\end{column}
...
\includegraphics[height=0.8\textheight]{../images/week11/CAC_figure2_occ_smooth.pdf}
\end{column}
\end{columns}
\end{frame}
% -----------------------------------------
...
\begin{center}
\only<1>{\includegraphics[height=0.85\textheight]{../images/week11/EGW_2024_fig1.pdf}}
\only<2>{\includegraphics[height=0.85\textheight]{../images/week11/EGW_2024_fig6ab.pdf}}
\only<3>{\includegraphics[height=0.85\textheight]{../images/week11/EGW_2024_fig6cd.pdf}}
\end{center}
\end{frame}
...
\end{itemize}
\vspace{1mm}
\href{https://local.theonion.com/neighborhood-starting-to-get-too-safe-for-family-to-aff-1819578182}{\includegraphics[width=0.7\textwidth]{../images/week11/Onion20150828.png}}
\end{frame}
% -----------------------------------------
...
\end{itemize}
\begin{center}
\includegraphics[height=.45\textheight]{../images/week11/GlaeserGyourko2005_fig1.pdf}\\
\vspace{-2mm}
...
\begin{center}
\includegraphics[width=\textwidth]{../images/week11/GlaeserGyourko2018_fig2c.png}\\
\href{https://www.aeaweb.org/articles?id=10.1257/jep.32.1.3}{Glaeser \& Gyourko (JEP 2018)}\end{center}
\end{frame}
% -----------------------------------------
\begin{frame}{Housing supply elasticities -- prices vs quantities}
\begin{center}
\includegraphics[height=0.95\textheight]{../images/week11/GlaeserGyourko2018_fig2.png}
\end{center}
\end{frame}
% -----------------------------------------
\begin{frame}{Incidence of building restrictions}
\begin{center}
\includegraphics[height=.80\textheight]{../images/week11/GlaeserGyourko2018_fig4.png}\\
...
\end{itemize}
\begin{center}
\includegraphics[width=.7\textwidth]{../images/week11/Diamond_logitshares.png}
\end{center}
\end{frame}
% -----------------------------------------
...
\begin{center}\includegraphics[height=0.88\textheight]{../images/week11/BBS2009tab5.pdf}\end{center}
\vspace{-5mm}
...
\input{../images/week11/BSPvsCensus.tex}
\hyperlink{NLSY_main}{\beamerreturnbutton}
\end{frame}
% -----------------------------------------
\end{document}
