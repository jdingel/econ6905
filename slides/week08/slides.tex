...
%TODO: I would love to figure out the problem Rodrigo told me about intermediates and shares.
\begin{itemize}
...
%\item
%One interpretation of these isomorphisms: we can normalize $T_i = L_i = 1 \ \forall i$.
...
\end{frame}
% -----------------------------------------
%https://twitter.com/borusyak/status/1550633634427801605
%https://twitter.com/straiberman/status/1550640352473845765
%https://twitter.com/TradeDiversion/status/1551212313985835010
%A saturated model calibrated to observed shares may still be falsifiable
%Triangle inequality: 
%Tests of IIA (Adao Costinot Donaldson; Lind Ramondo)
%Think about McFadden test of IIA; another test proposed by Hausman and McFadden (1984) based on an estimation of the nested logit model
%Test of pass-through assumptions: tariffs raise prices one-for-one
%Trade costs are positive (CIF vs FOB prices)
\end{document}
