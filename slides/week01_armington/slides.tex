...
\item You should attend the Trade and Spatial Colloquium (Wednesdays, 12:00--1:00) %in IAB 1101
and the Trade and Spatial Workshop (select Fridays, 1:30--5:00) %in IAB 1101
\end{itemize}
\end{frame}
% -----------------------------------------
...
\begin{itemize}
\item Matt Gentzkow and Jesse Shapiro - \href{https://web.stanford.edu/~gentzkow/research/CodeAndData.pdf}{Code and Data for the Social Sciences}
...
\item Iterate until implied $\mathbf{Y}$ equals $\mathbf{Y}^{s}$ (the fixed point)
\end{itemize}
\end{frame}
% -----------------------------------------
